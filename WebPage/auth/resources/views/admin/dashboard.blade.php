    ...
    <div class="container">
      <div class="content">
        ...
        <div class="account">
          ...
          <a href="#"><label>{{ Auth::user()->name }}</label></a>
          <i class="fa fa-sign-out"></i><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><label>{{ __('Logout') }}</label></a>
